...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* MODAIS CSS PURO (Sem JavaScript) */
        .modal { 
        ...
        .close { 
            ...
            position: absolute; top: 15px; right: 25px; text-decoration: none;
        }
...
<body>
    ...
    <footer>
        <div class="footer-content">
            <div class="footer-cols">
                ...
                <div class="footer-col">
                    <h4>Navegação</h4>
                    <a href="#modal-privacidade">Política de Privacidade</a>
                    <a href="#modal-termos">Termos de Uso</a>
                    <a href="#modal-contato">Fale Conosco</a>
                </div>
            </div>
            
            <div class="footer-bottom">
                <div class="footer-links-nav">
                    <a href="#modal-privacidade">Privacidade</a>
    ...
    <!-- MODAIS LEGAIS (CSS PURO via :target) -->
